public class Archer extends Hero {
    ...
    public void useSkill(Character foe) {
        if (this.skill.getNameSkill().equals("Kemampuan Khusus")) {
            foe.hp -= this.skill.getDamage();
            System.out.println(this.name + " menggunakan " + this.skill.getDamage() + " dan mengurangi " + this.skill.getDamage() + " HP");
        }
    }
}
